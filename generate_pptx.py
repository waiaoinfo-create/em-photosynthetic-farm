...
# SLIDE 22-24: 如何購買
# ============================================================
add_section_slide("捌", "如何購買EM菌與光合菌", "實體通路 · 線上通路 · 價格參考 · 注意陷阱")

add_content_slide("如何購買 EM 菌", [
    ("線上購買管道\n", "蝦皮購物：搜尋「EM菌」、「EM菌種」，價格 140~450 元/L\n露天拍賣：搜尋「EM益生菌」，價格 150~500 元/L\nPChome / momo：搜尋「EM Environment」，價格 200~600 元/L\nBigGo：比價所有平台，查即時價格"),
    ("實體管道\n", "各地農會供銷部\n農業資材行（鄉鎮級）\n水族館（水族用EM菌，濃度較低）\n農藥行有機資材專區"),
    ("價格參考\n", "1L瓶裝：150~300元／5L桶裝：400~800元\n20L桶裝：1,200~3,000元\nEM菌種粉500g（自產劑）：150~250元 → 可產40L\n買自產劑自製僅市售1/10價格"),
    ("⚠ 保存期限\n", "液體EM菌出廠超過2個月活菌數大幅下降\n購買時務必確認製造日期\n自製菌液1個月內最佳，2個月後活菌降約50%"),
    ("💡 省錢結論\n", "買EM活菌自產劑500g（150~250元）回來自製\n首次桶子+自產劑總花費不到500元\n之後每次培養僅花糖錢約100元"),
])

add_content_slide("如何購買光合菌", [
    ("線上購買管道\n", "蝦皮搜尋「光合菌」：20L桶裝 / 1L瓶裝，150~500元\n仲達生物科技：自行培養組合，500~1,000元\n蕭博士光合菌：培養基90元/包（可產15L）\n水產試驗所：直接電話洽詢，技術轉移"),
    ("如何判斷好壞\n", "✅ 好菌：暗紅/紫紅色 · 醬油香或烏梅味 · 食工所來源\n❌ 壞菌：灰黑/綠色混濁 · 惡臭酸敗 · 來路不明\n⚠ 台大研究：市售部分產品完全不含光合菌"),
    ("最佳取得管道\n", "食品工業發展研究所（FIRDI）→ 參加免費光合菌課程\n課堂上提供母菌+培養基配方 → 自己回去擴培\n這是成本最低、品質最可靠的方式"),
])

# ============================================================
# SLIDE 25-28: 食工所課程
# ============================================================
add_section_slide("玖", "食工所免費光合菌課程", "農業部農糧署全額補助")

add_content_slide("食工所課程資訊", [
    ("基本資訊\n", "主辦：食品工業發展研究所（FIRDI）\n補助：農業部農糧署\n名稱：農業光合菌訓練班\n費用：免費（農糧署全額補助）\n對象：農民、青農、有興趣者\n內容：光合菌簡介、培養技術、田間應用、實作\n現場提供：母菌+培養基配方+操作教學"),
    ("追蹤最新課程方式\n", "食工所FB：搜尋「財團法人食品工業發展研究所」或 @firdi1965\n食工所官網：www.firdi.org.tw → 產業學院\n各地農會公告：台南新市農會、雲林豐泰文教基金會等協辦\n有機農業全球資訊網：info.organic.org.tw\n上下游新聞：www.newsmarket.com.tw"),
    ("114年度實際開課紀錄\n", "2025年3月：宜蘭場（花改場蘭陽分場）\n2025年5月：台南新市農會\n2025年6月：雲林場（豐泰文教基金會）\n每年約3~7月開課，建議現在追蹤食工所FB"),
])

add_content_slide("母菌取得替代方案", [
    ("方案一：食工所 BCRC\n", "電話：(03)522-3191\n直接詢問是否可購買光合菌菌種\n生物資源保存中心有保存多種菌株"),
    ("方案二：水產試驗所\n", "海水養殖研究中心 (06)788-0461\n洽詢是否有開放菌種購買或技術轉移"),
    ("方案三：問附近產銷班\n", "詢問已上過食工所課程的農友\n可向他們索取少量母菌開始培養"),
    ("方案四：先買市售試用\n", "蝦皮買一瓶150元光合菌液 → 當母菌+培養基+RO水擴培\n不是食工所純菌但成本極低，先感受效果"),
    ("🍯 蜂蜜 trick\n", "先去蝦皮買一瓶150元光合菌液當母菌\n+ 培養基90元 + RO水 → 先擴培試用\n之後再參加食工所課程拿正版母菌"),
])
...
# SLIDE 29-32: 真實案例
# ============================================================
add_section_slide("拾", "真實案例深度拆解", "台灣農民第一手實證數據")
...
# SLIDE 26-27: 常見失敗
# ============================================================
add_section_slide("拾壹", "常見失敗原因與排除對策")
